...
import type { Location, Message } from "../../types/line/line_types.js";
import nacl from "tweetnacl";
import { InternalError } from "../core/utils/error.js";
import * as LINETypes from "../../types/line/line_types.js";
	...
	async __encryptAESCTR(
		...
		return Buffer.from(
			await globalThis.crypto.subtle.encrypt(
				{
					name: "AES-CTR",
					counter: nonce as unknown as BufferSource,
					length: 32,
				},
